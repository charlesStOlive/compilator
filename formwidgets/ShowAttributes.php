<?php namespace Waka\Compilator\FormWidgets;
...
class ShowAttributes extends FormWidgetBase
{
     ...
     * @inheritDoc
     */
    protected $defaultAlias = 'waka_compilator_show_attributes';
    ...
    {
        $this->addCss('css/showattributes.css', 'Waka.Compilator');
        $this->addJs('js/showattributes.js', 'Waka.Compilator');
    }
